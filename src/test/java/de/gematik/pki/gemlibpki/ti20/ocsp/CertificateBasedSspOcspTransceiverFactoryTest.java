...
class CertificateBasedSspOcspTransceiverFactoryTest {

  private final X509Certificate eeCert = VALID_X509_EE_CERT_SMCB;
  private CertificateBasedSspOcspTransceiverFactory factory;
  ...
  void setup() {
    ...
    factory =
        new CertificateBasedSspOcspTransceiverFactory(
            PRODUCT_TYPE, tspServices, TIMEOUT, TOLERATE_FAILURE);
  }

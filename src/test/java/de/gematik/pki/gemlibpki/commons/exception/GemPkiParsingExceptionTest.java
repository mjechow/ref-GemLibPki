...
package de.gematik.pki.gemlibpki.commons.exception;
...
class GemPkiParsingExceptionTest {
  ...
  void nonNullTests() {
    ...
    final Map<CertificateProfile, GemPkiException> map =
        Map.of(
            CertificateProfile.CERT_PROFILE_C_HCI_AUT_ECC,
            new GemPkiException("productType", ErrorCode.TE_1029_OCSP_CHECK_REVOCATION_ERROR));

    assertNonNullParameter(() -> new GemPkiParsingException(null, map), "productType");

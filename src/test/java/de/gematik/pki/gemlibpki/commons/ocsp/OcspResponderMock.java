...
public class OcspResponderMock {
  ...
  private final Integer fixedPort; // optional, null → dynamic port

  public OcspResponderMock(final String sspDir, final String ocspHost) {
    this(sspDir, ocspHost, null);
  }

  public OcspResponderMock(final String sspDir, final String ocspHost, final Integer port) {
    this.sspDir = sspDir;
    this.ocspHost = ocspHost;
    this.fixedPort = port;
  }

  public static OcspResponderMock createAndStart(
      final String sspDir, final String ocspHost, final Integer port) {
    final OcspResponderMock ocspResponderMock = new OcspResponderMock(sspDir, ocspHost, port);
    ocspResponderMock.start();
    return ocspResponderMock;
  }
  ...
  public synchronized void start() {
    ...
    wireMockServer =
        (fixedPort == null)
            ...
            : new WireMockServer(options().port(fixedPort));

...
public class TucPki001Verifier {
  ...
  public Optional<TrustAnchorUpdate> performTucPki001Checks() throws GemPkiException {
    ...
    final TucPki018Verifier certVerifier = getOrCreateCertVerifier();
  ...
  private TucPki018Verifier getOrCreateCertVerifier() {
    ...
    if (tucPki018Verifier != null) {
      return tucPki018Verifier;
    }
  ...
  private Optional<TrustAnchorUpdate> getVerifiedAnnouncedTrustAnchorUpdate(
    ...
    try {
      ...
      final TSPServiceType certChangeTspServiceType = certChangeTspServiceTypeList.getFirst();

...
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_ANY;
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_EGK_AUT;
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_EGK_AUT_ALT;
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_EGK_SIG;
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_FD_OSIG;
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_FD_SIG;
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_FD_TLS_C;
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_FD_TLS_S;
...
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_SMC_B_ENC;
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_SMC_B_OSIG;
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_VPNK_VPN;
import static de.gematik.pki.gemlibpki.commons.certificate.CertificateType.CERT_TYPE_VPNK_VPN_SIS;
import static de.gematik.pki.gemlibpki.commons.certificate.ExtendedKeyUsage.EXT_KEYUSAGE_ID_KP_CLIENTAUTH;
import static de.gematik.pki.gemlibpki.commons.certificate.ExtendedKeyUsage.EXT_KEYUSAGE_ID_KP_EMAILPROTECTION;
import static de.gematik.pki.gemlibpki.commons.certificate.ExtendedKeyUsage.EXT_KEYUSAGE_ID_KP_SERVERAUTH;
import static de.gematik.pki.gemlibpki.commons.certificate.ExtendedKeyUsage.EXT_KEYUSAGE_ID_TSL_KP_TSLSIGNING;
import static de.gematik.pki.gemlibpki.commons.certificate.KeyUsage.KEYUSAGE_DATA_ENCIPHERMENT;
import static de.gematik.pki.gemlibpki.commons.certificate.KeyUsage.KEYUSAGE_DIGITAL_SIGNATURE;
import static de.gematik.pki.gemlibpki.commons.certificate.KeyUsage.KEYUSAGE_KEY_AGREEMENT;
import static de.gematik.pki.gemlibpki.commons.certificate.KeyUsage.KEYUSAGE_KEY_ENCIPHERMENT;
import static de.gematik.pki.gemlibpki.commons.certificate.KeyUsage.KEYUSAGE_NON_REPUDIATION;

...
package de.gematik.pki.gemlibpki.commons.error;

import static de.gematik.pki.gemlibpki.commons.error.ErrorClassifier.SECURITY_ERROR;
import static de.gematik.pki.gemlibpki.commons.error.ErrorClassifier.SECURITY_WARNING;
import static de.gematik.pki.gemlibpki.commons.error.ErrorClassifier.TECHNICAL_ERROR;
import static de.gematik.pki.gemlibpki.commons.error.ErrorClassifier.TECHNICAL_WARNING;
import static de.gematik.pki.gemlibpki.commons.error.ErrorSeverity.SEVERITY_ERROR;
import static de.gematik.pki.gemlibpki.commons.error.ErrorSeverity.SEVERITY_WARNING;
